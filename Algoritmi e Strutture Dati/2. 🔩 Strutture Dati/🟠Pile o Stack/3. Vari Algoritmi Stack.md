...
>- Il primo $while$ scorre gli $n+m$ elementi dei due stack con un tempo di max(n, m)*2  (dove max(n, m) )
>- finchè uno dei due non è vuoto e li confronta avendo vari casi possibili:
>	- se $P.top < Q.top$ o $P.top > Q.top \rightarrow θ(1)$
>	- se $P.top == Q.top \rightarrow θ(1)$
...
>Il secondo ciclo $while$ ribalta l'array $S$ contenente gli elementi uguali