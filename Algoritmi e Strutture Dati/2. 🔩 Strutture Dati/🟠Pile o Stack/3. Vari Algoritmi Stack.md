...
>
>- $T_{migliore}(n) = 2 \Rightarrow Ω(1) \rightarrow$ uno dei due stack è vuoto, così che i due cicli $while$ non entreranno mai nel corpo
>- $T_{peggiore}(n) = 2n\Rightarrow O(n) \rightarrow$ i due stack sono uguali e hanno tutti numeri diversi eseguendo così il primo e il secondo ciclo $while$ per $n$ volte