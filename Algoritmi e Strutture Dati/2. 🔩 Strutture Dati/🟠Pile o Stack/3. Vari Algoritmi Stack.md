...
>
>- $T_{migliore}(n) = 2 \Rightarrow Ω(1) \rightarrow$ l'elemento in cima allo stack con più elementi è maggiore o minore di tutti gli elementi dell'altro 
>- $T_{peggiore}(n) = 2n \Rightarrow O(n) \rightarrow$ 