...
>- Il tempo della **contrazione** è costante $θ(1)$.
>***
>- Passiamo alla **SBT_Del**:
>	- Il caso 1 è costante $\rightarrow θ(1)$.
>	- Il caso 2 è costante per la contrazione $θ(1)$
>	- Il caso 3 dipende dal costo della ricerca del successore ed è quindi potenzialmente $O(h)$.