...
Poiché $(S, F)$ è un **matroide**, sappiamo che $I'$ deve contenere almeno un elemento in più rispetto a $X$ (ovvero $|I'| > |X|$). Tuttavia, l’algoritmo greedy standard aggiunge elementi uno alla volta, quindi $|X|$ raggiunge $|I'|$ solo nel passo successivo.