...
- $color \rightarrow$ vettore dei **colori** di lunghezza $|V|$
	...
	- `dopo` la visita: $color[v] = Bianco$ per ogni vertice non visitato
	- `dopo` la visita: $color[v] = Nero$ per ogni vertice visitato
	- `durante` la visita: $color[v] = Grigio$ se $v$ ha degli adiacenti da ispezionare
