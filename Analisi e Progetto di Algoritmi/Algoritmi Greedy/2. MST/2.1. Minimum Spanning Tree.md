...
>[!Corollario]
>Dati un grafo connesso non orientato e pesato $G = (V, E)$, un sottoinsieme $A$ di un $MST$ per $G$ e una componente connessa $C = (V_C, A_C)$ nella foresta $G_A = (V, A)$, allora un arco leggero $(u, v)$ del taglio $(V_C, V − V_C)$ è un **arco sicuro** di $A$, dato che $(V_C, V- V_C)$ è sicuramente un taglio che rispetta $A$.
>
