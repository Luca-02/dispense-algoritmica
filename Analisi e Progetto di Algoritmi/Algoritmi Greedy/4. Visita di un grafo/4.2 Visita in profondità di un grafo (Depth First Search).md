...
- $v$ è **antenato** di $u$ nello stesso albero della visita $$d[v] < d[u]$$

![[Pasted image 20231230182040.png]]

#### Arco in avanti (arco $F$)
È un arco $(u,v)$ tale che $v$ è $Nero$ quando l’arco viene esplorato.
- $u$ **non** è predecessore di $v$ nella visita
- $v$ è **discendente** di $u$ nello stesso albero della visita $$d[v] > d[u]$$
