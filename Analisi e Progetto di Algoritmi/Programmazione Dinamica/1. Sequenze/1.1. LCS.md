...
2. Se $z_k=x_m$, allora $Z$ è una sottosequenza comune di $X_{m−1}$ e $Y$. Se esi-stesse una sottosequenza comuneWdiXm−1eYdi lunghezza maggiore dik,alloraWsarebbe anche una sottosequenza comune diXmeY, contraddicendol’ipotesi cheZ`e una LCS diXeY.
