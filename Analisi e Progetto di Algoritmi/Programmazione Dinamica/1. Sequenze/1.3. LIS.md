...
Sia $X=⟨x_1, x_2, …, x_{m-1}, x_m⟩$ una sequenza di numeri interi e sia $X_i$ un suo prefisso. Sia $Z^i$ una $LIS$ di $X_i$ e che termina con $x_i$. Allora vale che $$Z^i = Z^∗ |x_i$$con $Z^∗ ∈ W_i$ e $|Z^∗ | = max_{W∈W_i} \{|W|\}$ dove $W_i$ è l’insieme di tutte le sottosequenze crescenti di $X_j$ a cui è possibile concatenare $x_i$.
#### Dimostrazine
**Per assurdo** 
