...
Sia $X=⟨x_1, x_2, …, x_{m-1}, x_m⟩$ una sequenza di numeri interi e sia $X_i$ un suo prefisso di lunghezza $i$ con $1 ≤ i ≤ m$. Sia $Z^i$ una tra le più lunghe sottosequenze crescenti di $X_i$ e che termina con $x_i$.
